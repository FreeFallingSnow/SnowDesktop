...
int main()
{
    ...
    const auto newer = ParseGitHubRelease(
        R"({"tag_name":"v1.0.5.0","html_url":"https://github.com/FreeFallingSnow/SnowDesktop/releases/tag/v1.0.5.0"})",
        "1.0.4.0");
    ...
    const auto current = ParseGitHubRelease(
        R"({"tag_name":"1.0.4.0","html_url":"https://github.com/FreeFallingSnow/SnowDesktop/releases/tag/v1.0.4.0"})",
        "1.0.4.0");
    ...
    const auto older = ParseGitHubRelease(
        R"({"tag_name":"v1.0.3.0","html_url":"https://github.com/FreeFallingSnow/SnowDesktop/releases/tag/v1.0.3.0"})",
        "1.0.4.0");
    ...
    Check(!ParseGitHubRelease(
            ...
            "1.0.4.0").parsed,
        "the retired binary repository is no longer an update destination");
             ...
             "v1.0.4.0.0", "v42949672960.0.0.0"})
    {
        const std::string body = std::string(
            ...
            R"(","html_url":"https://github.com/FreeFallingSnow/SnowDesktop/releases/latest"})";
