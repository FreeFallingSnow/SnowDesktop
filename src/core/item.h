...
// ── ExternalFileItem : wraps paths from external drag-drop ───
// Lightweight; only GetPath/GetTitle are meaningful. Used as source
// when OnItemsDropped receives files from an external window.
