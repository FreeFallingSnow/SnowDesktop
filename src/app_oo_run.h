#pragma once
// Inline implementations for SnowDesktopAppOO — destructor, Run, WndProc, HandleMessage.
// This file is included by app_oo.h after the class definition.

// ── Inline implementations ──────────────────────────────────

inline SnowDesktopAppOO::~SnowDesktopAppOO()
{
    items_oo_.clear();
    containers_.clear();
}

inline int SnowDesktopAppOO::Run(HINSTANCE instance, int showCommand)
{
    ...
    wc.lpszClassName = L"SnowDesktopOOWindow";
    RegisterClassExW(&wc);
    ...
    hwnd_ = CreateWindowExW(WS_EX_TOOLWINDOW, wc.lpszClassName, L"SnowDesktopOO",
    ...
    controlHwnd_ = CreateWindowExW(WS_EX_TOOLWINDOW | WS_EX_NOACTIVATE,
        kControlWindowClassName, L"SnowDesktopOOControl", WS_POPUP,
...
inline LRESULT CALLBACK SnowDesktopAppOO::WndProc(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp)
{
...
inline LRESULT SnowDesktopAppOO::HandleMessage(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp)
{
