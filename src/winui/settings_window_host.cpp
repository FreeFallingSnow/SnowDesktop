...
constexpr StaticSearchDefinition kStaticSearchDefinitions[] = {
    ...
    {SettingsPage::StatusBar, "statusBar.theme", "statusBar.defaultAppearance", "settings.nav.statusBar"},
    {SettingsPage::StatusBar, "statusBar.shellUi", "app.settings.taskbar_dynamic_shell_ui", "settings.nav.statusBar"},
    {SettingsPage::StatusBar, "statusBar.maximizedWindow", "app.settings.taskbar_dynamic_maximized_window", "settings.nav.statusBar"},
    {SettingsPage::StatusBar, "statusBar.visibleWindow", "app.settings.taskbar_dynamic_visible_window", "settings.nav.statusBar"},
    ...
    {SettingsPage::StatusBar, "statusBar.traffic", "statusBar.traffic", "statusBar.information"},
