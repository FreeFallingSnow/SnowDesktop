...
constexpr StaticSearchDefinition kStaticSearchDefinitions[] = {
    ...
    {SettingsPage::ContextMenu, "contextMenu.application", "settings.contextMenu.application", "settings.contextMenu.extensions"},
    {SettingsPage::ContextMenu, "contextMenu.extension", "settings.contextMenu.extension", "settings.contextMenu.extensions"},
    {SettingsPage::ContextMenu, "contextMenu.batch", "settings.contextMenu.batch", "settings.contextMenu.batchHint"},
